...
-keep class tech.tekkiech.mussiech.models.PersistQueue { *; }
-keep class tech.tekkiech.mussiech.models.PersistPlayerState { *; }
-keep class tech.tekkiech.mussiech.models.QueueData { *; }
-keep class tech.tekkiech.mussiech.models.QueueType { *; }
-keep class tech.tekkiech.mussiech.playback.queues.** { *; }
