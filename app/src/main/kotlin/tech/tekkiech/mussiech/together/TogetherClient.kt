...
sealed interface TogetherClientEvent {
    ...
    data class JoinDecision(
        val decision: tech.tekkiech.mussiech.together.JoinDecision,
    ) : TogetherClientEvent

    data class HostTransferred(
        val transfer: tech.tekkiech.mussiech.together.HostTransferred,
    ) : TogetherClientEvent
    ...
    data class HeartbeatPong(
        val pong: tech.tekkiech.mussiech.together.HeartbeatPong,
                ...
                try {
                    while (true) {
                        ...
                        when (message) {
                            ...
                            is tech.tekkiech.mussiech.together.JoinDecision -> {
                            ...
                            is tech.tekkiech.mussiech.together.HostTransferred -> {
                                if (message.sessionId == sessionId) {
