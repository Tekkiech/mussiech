...
import tech.tekkiech.mussiech.extensions.toggleRepeatMode
...
import tech.tekkiech.mussiech.utils.oem.SystemMediaControlResolver
...
fun Queue(
    ...
    val togetherForcesLock =
        togetherSessionState is tech.tekkiech.mussiech.together.TogetherSessionState.Joined &&
            (togetherSessionState as tech.tekkiech.mussiech.together.TogetherSessionState.Joined).role is tech.tekkiech.mussiech.together.TogetherRole.Guest
                                                    ...
                                                    onClick = {
                                                        if (selection) {
                                                            ...
                                                            if (index == currentWindowIndex) {
                                                                ...
                                                                val joined =
                                                                    togetherSessionState as? tech.tekkiech.mussiech.together.TogetherSessionState.Joined
                                                                val isGuest = joined?.role is tech.tekkiech.mussiech.together.TogetherRole.Guest
                                                                if (isGuest) {
