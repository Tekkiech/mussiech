...
package tech.tekkiech.mussiech.musicrecognition
...
class BackgroundMusicRecognitionService : Service() {
    ...
    companion object {
        private const val ActionRecognizePlayback =
            "tech.tekkiech.mussiech.action.RECOGNIZE_DEVICE_PLAYBACK"
        private const val ActionRecognizeMicrophone =
            "tech.tekkiech.mussiech.action.RECOGNIZE_MICROPHONE"
        private const val ActionCancel =
            "tech.tekkiech.mussiech.action.CANCEL_BACKGROUND_RECOGNITION"
