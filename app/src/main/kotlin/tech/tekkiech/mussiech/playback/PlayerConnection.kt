...
import tech.tekkiech.mussiech.extensions.getCurrentQueueIndex
...
import tech.tekkiech.mussiech.ui.player.refetchCanvasArtworkForPlayback
...
class PlayerConnection(
    ...
    fun seekToNext() {
        val state = service.togetherSessionState.value as? tech.tekkiech.mussiech.together.TogetherSessionState.Joined
        if (state?.role is tech.tekkiech.mussiech.together.TogetherRole.Guest) {
            service.requestTogetherControl(tech.tekkiech.mussiech.together.ControlAction.SkipNext)
            return
        }
        player.seekToNext()
        player.prepare()
    ...
    fun seekToPrevious() {
        val state = service.togetherSessionState.value as? tech.tekkiech.mussiech.together.TogetherSessionState.Joined
        if (state?.role is tech.tekkiech.mussiech.together.TogetherRole.Guest) {
            service.requestTogetherControl(tech.tekkiech.mussiech.together.ControlAction.SkipPrevious)
            return
        }
