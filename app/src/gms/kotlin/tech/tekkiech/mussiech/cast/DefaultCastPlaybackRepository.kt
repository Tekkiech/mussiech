...
package tech.tekkiech.mussiech.cast
...
private class GmsCastMediaItemConverter(
    ...
    private fun MediaInfo?.toAppMediaMetadata(mediaId: String): tech.tekkiech.mussiech.models.MediaMetadata {
        val castMetadata = this?.metadata
        val title = castMetadata?.stringValue(CastMetadata.KEY_TITLE) ?: mediaId
        val artistText =
        ...
        return tech.tekkiech.mussiech.models.MediaMetadata(
            ...
            album =
                albumTitle?.let {
                    tech.tekkiech.mussiech.models.MediaMetadata.Album(
                        id = it,
                        title = it,
                    )
                },
